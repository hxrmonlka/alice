  ...
  flake.custom.userModules.aliceMangoConfig = {
    ...
    wayland.windowManager.mango = {
      ...
      settings = ''
        ...
        # Noctalia IPC
        bind=SUPER,s,spawn,${lib.getExe self.packages.${pkgs.stdenv.hostPlatform.system}.aliceNoctalia} ipc call launcher toggle
        bind=SUPER,m,spawn,${lib.getExe self.packages.${pkgs.stdenv.hostPlatform.system}.aliceNoctalia} ipc call media toggle
        bind=SUPER+ALT,l,spawn,${lib.getExe self.packages.${pkgs.stdenv.hostPlatform.system}.aliceNoctalia} ipc call lockScreen lock
        bind=SUPER+SHIFT,t,spawn,${lib.getExe self.packages.${pkgs.stdenv.hostPlatform.system}.aliceNoctalia} ipc call wallpaper toggle
        bind=SUPER+SHIFT,i,spawn,${lib.getExe self.packages.${pkgs.stdenv.hostPlatform.system}.aliceNoctalia} ipc call controlCenter toggle
        bind=CTRL+ALT,Delete,spawn,${lib.getExe self.packages.${pkgs.stdenv.hostPlatform.system}.aliceNoctalia} ipc call sessionMenu toggle
        bind=SUPER,v,spawn,${lib.getExe self.packages.${pkgs.stdenv.hostPlatform.system}.aliceNoctalia} ipc call launcher clipboard
